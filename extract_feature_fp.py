...
def get_args():
    ...
    parser.add_argument('--csv_path', type=str, default="/home/auwqh/dataset/PDL1/meta_data/Testing/patch/process_list_autogen.csv", help="Path to the CSV file listing all bags.")
