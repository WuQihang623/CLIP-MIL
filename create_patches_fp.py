...
from src.wsi_core.WholeSlideImage import WholeSlideImage
from src.wsi_core.wsi_utils import StitchCoords
from src.wsi_core.batch_process_utils import initialize_df
# other imports
import os
import numpy as np
import time
...
def seg_and_patch(source, save_dir, patch_save_dir, mask_save_dir, stitch_save_dir,
    ...
    for i in range(total):
        ...
        # Inialize WSI
        matching_paths = [path for path in slides_paths if slide in path]
