...
--feature_dim 512 --feat_dir "/home/auwqh/dataset/HER2/patch/clip_ViTB32/pt_files/" \
...
srun python train_MIL.py --model_name "ABMIL" \
--feature_dim 1024 --feat_dir "/home/auwqh/dataset/HER2/patch/resnet50-imagenet/pt_files/" \
--fold_dir "/home/auwqh/code/CLIP-MIL/data/HER2_fold/" --batch_size 1 \
--n_epochs 50 --workers 4 --save_dir "/home/auwqh/code/CLIP-MIL/save_weights/HER2" \
--log_name "ABMIL_resnet50_imagenet_weights" --lr 0.0001 --step_size 15 --gamma 0.1 --n_classes 4
...
--fold_dir "/home/auwqh/code/CLIP-MIL/data/HER2_fold/" --batch_size 1 \
--n_epochs 50 --workers 4 --save_dir "/home/auwqh/code/CLIP-MIL/save_weights/HER2" \
--log_name "CLAM_MB_resnet50_imagenet_weights" --lr 0.0001 --step_size 15 --gamma 0.1 --n_classes 4
...
--fold_dir "/home/auwqh/code/CLIP-MIL/data/HER2_fold/" --batch_size 1 \
--n_epochs 50 --workers 4 --save_dir "/home/auwqh/code/CLIP-MIL/save_weights/HER2" \
--log_name "TransMIL_resnet50_imagenet_weights" --lr 0.0001 --step_size 15 --gamma 0.1 --n_classes 4
